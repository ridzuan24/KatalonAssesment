...
class loginUser {
	...
	def enterDetails(String username, String password) {
	...
	def navivgatetohomepage() {

		WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OrangeHRM/span_Paul nihal'), 0)
	}
}