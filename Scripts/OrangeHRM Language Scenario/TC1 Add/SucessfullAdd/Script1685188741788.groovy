...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/li_Languages'))

WebUI.waitForPageLoad(0)

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Add'))

WebUI.setText(findTestObject('Language/Page_OrangeHRM/input_Name_oxd-input oxd-input--focus'), language)
