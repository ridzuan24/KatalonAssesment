...
WebUI.click(findTestObject('QualificationSkill/RenameSkill/Page_OrangeHRM/a_Admin'))

WebUI.click(findTestObject('QualificationSkill/RenameSkill/Page_OrangeHRM/li_Qualifications'))

WebUI.click(findTestObject('QualificationSkill/RenameSkill/Page_OrangeHRM/li_Skills'))
...
WebUI.verifyElementPresent(findTestObject('QualificationSkill/SameSkillName/Page_OrangeHRM/Page_OrangeHRM/span_Already exists'), 
    0)
